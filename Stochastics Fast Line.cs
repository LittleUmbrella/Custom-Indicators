...
namespace Forex_Strategy_Builder
{
    /// <summary>
    /// Stochastics Indicator
	/// with opotion for signals from fast line crossing slow line
	/// calculate aDFast as Moving Average of adK, not sum of highs/sum of lows
    /// </summary>
    public class Stochastics_Fast_Line : Indicator
    {
        /// <summary>
        /// Sets the default indicator parameters for the designated slot type
        /// </summary>
        public Stochastics_Fast_Line(SlotTypes slotType)
        {
            // General properties
            IndicatorName  = "Stochastics Fast Line";
            ...
            {
				"The Fast %D is higher than the Slow %D",
                "The Fast %D is lower than the Slow %D",
                 "The Slow %D rises",
                "The Slow %D falls",
				"The %K is higher than the Level line",
                "The %K is lower than the Level line",
        ...
        public override void SetDescription(SlotTypes slotType)
        {
            ...
            switch (IndParam.ListParam[0].Text)
            {
                ...
                case "The %K is higher than the Level line":
                    EntryFilterLongDescription  += "the %K is higher than the Level " + sLevelLong;
                    EntryFilterShortDescription += "the %K is lower than the Level "  + sLevelShort;
                    ExitFilterLongDescription   += "the %K is higher than the Level " + sLevelLong;
                    ExitFilterShortDescription  += "the %K is lower than the Level "  + sLevelShort;
                    break;

                case "The %K is lower than the Level line":
                    EntryFilterLongDescription  += "the %K is lower than the Level "  + sLevelLong;
                    EntryFilterShortDescription += "the %K is higher than the Level " + sLevelShort;
                    ExitFilterLongDescription   += "the %K is lower than the Level "  + sLevelLong;
                    ExitFilterShortDescription  += "the %K is higher than the Level " + sLevelShort;
                    break;
                ...
                case "The Fast %D is higher than the Slow %D":
                    EntryFilterLongDescription  += "the Fast %D is higher than the Slow %D";
                    EntryFilterShortDescription += "the Fast %D is lower than the Slow %D";
                    ExitFilterLongDescription   += "the Fast %D is higher than the Slow %D";
                    ExitFilterShortDescription  += "the Fast %D is lower than the Slow %D";
                    break;

                case "The Fast %D is lower than  the Slow %D":
                    EntryFilterLongDescription  += "the Fast %D is lower than the Slow %D";
                    EntryFilterShortDescription += "theFast %D is higher than than the Slow %D";
                    ExitFilterLongDescription   += "the Fast %D is lower than the Slow %D";
                    ExitFilterShortDescription  += "the Fast %D is higher than than the Slow %D";
                    break;
