// Custom Moving Averages Crossover Indicator
...
namespace Forex_Strategy_Builder
{
    ...
    /// Custom Moving Averages Crossover Indicator
    /// </summary>
    public class Custom_Moving_Averages_Crossover : Indicator
    {
        /// <summary>
        /// Sets the default indicator parameters for the designated slot type
        /// </summary>
        public Custom_Moving_Averages_Crossover(SlotTypes slotType)
        {
            // General properties
            IndicatorName = "Custom Moving Averages Crossover";
            ...
            IndParam.ListParam[2].ToolTip  = "The price both Moving Averages are based on.";
